const quotePart = document.getElementById("quotePart");
const quote = document.getElementById("quote");
const quoteAuthor = document.getElementById("quoteAuthor");
const quoteBtnLeft = document.getElementById("quoteBtnLeft");
const quoteBtnRight = document.getElementById("quoteBtnRight");
...
const chosenQuote = quotes[index];
...
let quoteInterval = setInterval(quoteAnimation, 10000);
